      ...
      <div className="px-4 mb-8">
        <div className="flex flex-col md:flex-row rounded-2xl overflow-hidden bg-surface-light dark:bg-surface-dark shadow-sm border border-border-light dark:border-border-dark">
          <div 
            ...
            style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAXgX6rjJi2Xdn3heAwEeYh_9X5ZKgVojZxyw8aqlsi8GZ8VIyJ7OhjlSmyCpOJFnKc1j3-RKeubcrzsp_CaamQ3QSBEK3QjezXbFOC5ZsjpYMmSQkxBKNujiRz14R3SJfnk_yCQ5QKOtcrWpnXFJBCC8Lxf7aRDlimSblpuDar2R6ZUb0xfYV3O4U6EPyMxw_Z3hvBBfCZbvcth83Up2jznH-fpH1RrJJhjvd747ZdHvDBKKBw_V4HhRk7pLVWiV_OBebXfVDvI1fA")' }}
            role="img"
